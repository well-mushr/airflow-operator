...
# deliveryhero.net/airflow-operator-bundle:$VERSION and deliveryhero.net/airflow-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= deliveryhero.net/airflow-operator
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.28.1/ansible-operator_$(OS)_$(ARCH) ;\
